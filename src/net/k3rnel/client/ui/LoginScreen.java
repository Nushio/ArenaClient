...
import net.k3rnel.client.ui.frames.AboutDialog;
import net.k3rnel.client.ui.frames.CharacterSelectDialog;
import net.k3rnel.client.ui.frames.LanguageDialog;
import net.k3rnel.client.ui.frames.LoginDialog;
import net.k3rnel.client.ui.frames.RegisterDialog;
import net.k3rnel.client.ui.frames.ServerDialog;
import net.k3rnel.client.ui.frames.ToSDialog;
