...
//import net.k3rnel.client.backend.ItemDatabase;
//import net.k3rnel.client.backend.MoveLearningManager;
//import net.k3rnel.client.backend.Translator;
//import net.k3rnel.client.backend.entity.HMObject;
...
//import net.k3rnel.client.ui.frames.SpriteChooserDialog;
//
///**
...
//				m_game.getChooseCharDialog().setVisible(true);
//				m_game.setPlayerId(Integer.parseInt(details[0]));
//				m_game.getUi().setVisible(false);
//				m_game.getUi().getChat().setVisible(false);
...
//				break;
//			case '5':
//				GameClient.messageDialog(translated.get(38), GameClient.getInstance().getDisplay());
//				m_game.getLoginScreen().getRegistration().enableRegistration();
//				m_game.getLoadingScreen().setVisible(false);
//				break;
//			default:
//				GameClient.messageDialog("I don't know!", GameClient.getInstance().getDisplay());
//				m_game.getLoginScreen().getRegistration().enableRegistration();
//				m_game.getLoadingScreen().setVisible(false);
//				break;
//			}
